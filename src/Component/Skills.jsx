...
function Skills() {
  return (
    ...
    <div size={75}className="grid grid-cols-5 gap-10 text-1xl ml-12 items-center text-center  mt-28 justify-items-center  ">
        <div><FaHtml5  size={75}className="text-orange-500 shadow-md hover:animate-bounce  " /><h1>HTML</h1></div>
        ...
        <div><SiBootstrap size={75}className="text-purple-600 shadow-md hover:animate-spin" title="Bootstrap" /><h2>Bootstrap</h2></div>
